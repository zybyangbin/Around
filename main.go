...
const (
	...
	ES_URL      = "http://35.231.70.61:9200"
	BUCKET_NAME = "yz-post-image"
	API_PREFIX  = "/api/v1"
)
...
//old way:before image and using GCS.
...
func saveToBigTable(p *Post, id string) error {
	...
	bt_client, err := bigtable.NewClient(ctx, "upheld-arena-231703", "around-post")
	if err != nil {
		return err
	}
